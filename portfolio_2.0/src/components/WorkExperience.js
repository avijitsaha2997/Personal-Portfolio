            ...
            <motion.div
                ...
                <div className='w-full flex space-x-5 overflow-x-scroll p-10 snap-x snap-mandatory scrollbar scrollbar-track-gray-500/40 scrollbar-thumb-[#F7AB0A]'>
                    ...
                    <ExperienceCard
                        ...
                        experienceCardProjectImage1="https://icon-library.com/images/html5-icon/html5-icon-13.jpg"
                        experienceCardProjectImage2="https://www.shareicon.net/download/2016/08/01/639873_internet.svg"
