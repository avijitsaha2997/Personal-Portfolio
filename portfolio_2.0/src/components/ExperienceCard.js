...
function ExperienceCard({
  ...
  experienceName,
  experienceCardImage,
  experienceCardProjectImage1,
  experienceCardProjectImage2,
  experienceCardProjectImage3,
  experienceCardProjectImage4,
}) {
  return (
    <div>
      <article className="flex flex-col rounded-lg items-center space-y-7 flex-shrink-0 w-[500px] md:w-[600px] xl:w-[900px] snap-center bg-[#000]/50 p-10 hover:opacity-100 opacity-40 cursor-pointer transition-opacity duration-200 overflow-hidden">
        <motion.img
          initial={{
            y: -100,
            opacity: 0,
