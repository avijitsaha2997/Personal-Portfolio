    ...
    <div className="flex flex-col relative h-screen text-center md:text-left md:flex-row max-w-7xl px-7 justify-evenly mx-auto items-center">
      ...
      <div className="space-y-10 px-0 md:px-10 ">
        <h4 className="text-2xl md:text-4xl font-semibold">
          Here is,{" "}
          <span className="underline decoration-[#3374FF]/50">little</span>{" "}
          about myself
        </h4>
        <p className="text-base">
          I'm a Front-End Developer located in Bangladesh. I have a serious
          passion for UI effects, animations and creating dynamic user
          experiences. Well-organised person, problem solver, independent
          employee with high attention to detail. Completed many e-commerce
          projects on my own. I've almost 1.5 years of experience in this
          sector. Extra: Fan of Badminton, outdoor activities and TV series
          (especially magic and adventure) 👻.
        </p>
      </div>
    </div>
  );
